...
all(sapply(list(
  ...
  names(fi_w16), names(fi_w17), names(fi_w18)
...
all(sapply(list(
  ...
  names(nfi_w16), names(nfi_w17), names(nfi_w18)
...
all(sapply(list(
  ...
  names(market_services_w16), names(market_services_w17), names(market_services_w18)
...
all(sapply(list(
  ...
  names(ime_hawala_w16), names(ime_hawala_w17), names(ime_hawala_w18)
...
all(sapply(list(
  ...
  names(bank_w16), names(bank_w17), names(bank_w18)
...
all(sapply(list(
  ...
  names(border_traffic_count_w16), names(border_traffic_count_w17), names(border_traffic_count_w18)
...
all(sapply(list(
  ...
  names(telecome_service_w16), names(telecome_service_w17), names(telecome_service_w18)
...
all(sapply(list(
  ...
  names(bank_operationality_w16), names(bank_operationality_w17), names(bank_operationality_w18)
