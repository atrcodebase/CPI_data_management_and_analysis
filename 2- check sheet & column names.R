...
all(sapply(list(
  ...
  names(fi_w8), names(fi_w9), names(fi_w10), names(fi_w11), names(fi_w12), names(fi_w13)
...
all(sapply(list(
  ...
  names(nfi_w8), names(nfi_w9), names(nfi_w10), names(nfi_w11), names(nfi_w12), names(nfi_w13)
...
all(sapply(list(
  ...
  names(market_services_w8), names(market_services_w9), names(market_services_w10), names(market_services_w11), names(market_services_w12), names(market_services_w13)
...
all(sapply(list(
  names(ime_hawala_w12), names(ime_hawala_w13)
...
all(sapply(list(
  ...
  names(bank_w8), names(bank_w9), names(bank_w10), names(bank_w11), names(bank_w12), names(bank_w13)
...
all(sapply(list(
  ...
  names(border_traffic_count_w8), names(border_traffic_count_w9), names(border_traffic_count_w10), names(border_traffic_count_w11), names(border_traffic_count_w12), names(border_traffic_count_w13)
...
all(sapply(list(
  ...
  names(telecome_service_w8), names(telecome_service_w9), names(telecome_service_w10), names(telecome_service_w11), names(telecome_service_w12), names(telecome_service_w13)
...
all(sapply(list(
  names(bank_operationality_w9), names(bank_operationality_w10), names(bank_operationality_w11), names(bank_operationality_w12), names(bank_operationality_w13)
