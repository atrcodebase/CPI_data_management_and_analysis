...
all(sapply(list(
  ...
  names(fi_w16), names(fi_w17), names(fi_w18), names(fi_w19), names(fi_w20)
...
check_column_names(target = fi_w1, check_with = fi_w18)
check_column_names(target = fi_w1, check_with = fi_w19)
check_column_names(target = fi_w1, check_with = fi_w20)
...
all(sapply(list(
  ...
  names(nfi_w16), names(nfi_w17), names(nfi_w18), names(nfi_w19), names(nfi_w20)
...
check_column_names(target = nfi_w1, check_with = nfi_w18)
check_column_names(target = nfi_w1, check_with = nfi_w19)
check_column_names(target = nfi_w1, check_with = nfi_w20)
...
all(sapply(list(
  ...
  names(market_services_w16), names(market_services_w17), names(market_services_w18), names(market_services_w19), names(market_services_w20)
...
check_column_names(target = market_services_w1, check_with = market_services_w18)
check_column_names(target = market_services_w1, check_with = market_services_w19)
check_column_names(target = market_services_w1, check_with = market_services_w20)
...
all(sapply(list(
  ...
  names(ime_hawala_w16), names(ime_hawala_w17), names(ime_hawala_w18), names(ime_hawala_w19), names(ime_hawala_w20)
...
check_column_names(target = ime_hawala_w11, check_with = ime_hawala_w18)
check_column_names(target = ime_hawala_w11, check_with = ime_hawala_w19)
check_column_names(target = ime_hawala_w11, check_with = ime_hawala_w20)
...
all(sapply(list(
  ...
  names(bank_w16), names(bank_w17), names(bank_w18), names(bank_w19), names(bank_w20)
...
check_column_names(target = bank_w1, check_with = bank_w18)
check_column_names(target = bank_w1, check_with = bank_w19)
check_column_names(target = bank_w1, check_with = bank_w20)
...
all(sapply(list(
  ...
  names(border_traffic_count_w16), names(border_traffic_count_w17), names(border_traffic_count_w18), names(border_traffic_count_w19), names(border_traffic_count_w20)
...
check_column_names(target = border_traffic_count_w2, check_with = border_traffic_count_w18)
check_column_names(target = border_traffic_count_w2, check_with = border_traffic_count_w19)
check_column_names(target = border_traffic_count_w2, check_with = border_traffic_count_w20)
...
all(sapply(list(
  ...
  names(telecome_service_w16), names(telecome_service_w17), names(telecome_service_w18), names(telecome_service_w19), names(telecome_service_w20)
...
check_column_names(target = telecome_service_w1, check_with = telecome_service_w18)
check_column_names(target = telecome_service_w1, check_with = telecome_service_w19)
check_column_names(target = telecome_service_w1, check_with = telecome_service_w20)
...
all(sapply(list(
  ...
  names(bank_operationality_w16), names(bank_operationality_w17), names(bank_operationality_w18), names(bank_operationality_w19), names(bank_operationality_w20)
...
check_column_names(target = bank_operationality_w8, check_with = bank_operationality_w18)
check_column_names(target = bank_operationality_w8, check_with = bank_operationality_w19)
check_column_names(target = bank_operationality_w8, check_with = bank_operationality_w20)
