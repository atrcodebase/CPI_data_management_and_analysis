...
fi_subreps_ava_nava_tax_bartering <- rbind(
  ...
  fi_w20[["subreps_ava_nava_tax_bartering"]]
)
...
fi_items_prices_avail_notavail <- rbind(
  ...
  fi_w20[["fi_items_prices_avail_notavail"]]
)
...
nfi_nsubreps_ava_nava_tax_bartering <- rbind(
  ...
  nfi_w20[["nsubreps_ava_nava_tax_bartering"]]
)
...
nfi_items_prices_avail_notavail <- rbind(
  ...
  nfi_w20[["nfi_items_prices_avail_notavail"]]
)
...
market_services_subrespondents <- rbind(
  ...
  market_services_w20[["subrespondents"]]
)
...
market_services_subrespondents_avail_notavail <- rbind(
  ...
  market_services_w20[["subrespondents_avail_notavail"]]
)
...
market_services_subrespondents_available_data <- rbind(
  ...
  market_services_w20[["subrespondents_available_data"]]
)
...
ime_hawala_subresps_v2 <- rbind(
  ...
  ime_hawala_w20[["ime_hawala_subresps"]]
)
...
ime_hawala_Currency_Exchange_v2 <- rbind(
  ...
  ime_hawala_w20[["ime_hawala_Currency_Exchange"]]
)
...
ime_hawala_Hawala_Transfer_v2 <- rbind(
  ...
  ime_hawala_w20[["ime_hawala_Hawala_Transfer"]]
)
...
bank_operationality_data <- rbind(
  ...
  bank_operationality_w20[["bank_operationality_data"]]
)
...
no_bank <- rbind(
  ...
  bank_operationality_w20[["no_bank"]]
)
...
border_traffic_count_Traffic_count <- rbind(
  ...
  border_traffic_count_w20[["Traffic_count"]]
)
...
telecome_service <- rbind(
  ...
  telecome_service_w20[["telecom_data"]]
)
